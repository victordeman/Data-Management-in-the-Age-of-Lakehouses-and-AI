        ...
        this.innerHTML = `
            <header class="bg-white shadow-md p-4">
                <div class="container mx-auto flex justify-between items-center">
                    ...
                    <nav id="nav-menu" class="hidden absolute md:relative top-full left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 md:flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                        ...
                        <div class="relative">
                            <button class="dropdown-button text-gray-600 hover:text-primary-500 flex items-center w-full justify-between md:justify-start">
                                Slides <i data-feather="chevron-down" class="ml-1 w-4 h-4 md:hidden"></i>
                            </button>
                            <div class="hidden absolute md:group-hover:block bg-white shadow-md rounded-md mt-2 p-2 z-10 w-full md:w-auto">
